...
const OfferPlaceMange = () => {
  ...
  useEffect(() => {
    try {
      Offer.GetAllOffer().then((res) => setdataProvince(res.data.data));
    } catch (error) {}
  }, []);
  ...
  const UpdateState = (e) => {
    ...
    cookies.set("titeloffer", e.Places_name_ar);
  ...
  return (
    <div style={{ background: "#eef8fe", height: "100vh" }}>
      <HeaderDashBoard Title="اعدادات العروض" />
...
export default OfferPlaceMange;
